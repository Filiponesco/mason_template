...
class DevConfig extends AppConfig {
  DevConfig() : super._(""); //TODO - add dev config
}

class StagingConfig extends AppConfig {
  StagingConfig() : super._(""); //TODO - add stating config
}

class ProdConfig extends AppConfig {
  ProdConfig() : super._(""); //TODO - add prod config
}

class LocalConfig extends AppConfig {
  LocalConfig() : super._(""); //TODO - add local config
}
